...
func newLesson(db *gorm.DB, opts ...gen.DOOption) lesson {
	...
	_lesson.ID = field.NewString(tableName, "id")
	_lesson.CourseID = field.NewString(tableName, "course_id")
	_lesson.ChapterID = field.NewString(tableName, "chapter_id")
	_lesson.Title = field.NewString(tableName, "title")
	_lesson.Content = field.NewString(tableName, "content")
	_lesson.OrderIndex = field.NewInt32(tableName, "order_index")
...
func (l *lesson) updateTableName(table string) *lesson {
	...
	l.CourseID = field.NewString(table, "course_id")
	l.ChapterID = field.NewString(table, "chapter_id")
	l.Title = field.NewString(table, "title")
	l.Content = field.NewString(table, "content")
	l.OrderIndex = field.NewInt32(table, "order_index")
...
func (l *lesson) fillFieldMap() {
	...
	l.fieldMap["order_index"] = l.OrderIndex
}
...
type ILessonDo interface {
	...
	Unscoped() ILessonDo
	Create(values ...*model.Lesson) error
	CreateInBatches(values []*model.Lesson, batchSize int) error
	Save(values ...*model.Lesson) error
	First() (*model.Lesson, error)
	Take() (*model.Lesson, error)
	Last() (*model.Lesson, error)
	Find() ([]*model.Lesson, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Lesson, err error)
	FindInBatches(result *[]*model.Lesson, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Lesson) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Lesson, error)
	FirstOrCreate() (*model.Lesson, error)
	FindByPage(offset int, limit int) (result []*model.Lesson, count int64, err error)
